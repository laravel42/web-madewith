...
technology slug like `phoenix`, `gin`, or `ghost`.
    ...
    python workers/videos/cleanup_videos.py                 # dry run — report only
    python workers/videos/cleanup_videos.py --slug phoenix  # scope to one slug
    python workers/videos/cleanup_videos.py --apply         # actually delete
"""
