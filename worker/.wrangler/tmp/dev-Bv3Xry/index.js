...
var domain_catalog_default = [
  ...
  { slug: "ionic", techName: "Ionic", domain: "madewithionic.com", group: "frameworks", bespoke: true, scrape: { query: "topic:ionic", minStars: 20, exclude: ["ionic-team/ionic-framework", "ionic-team/ionic"] } },
  ...
  { slug: "react", techName: "React", domain: "madewithreact.com", group: "frameworks", bespoke: false, scrape: { query: "topic:react", minStars: 100, exclude: ["facebook/react"] } },
  { slug: "vue", techName: "Vue.js", domain: "madewithvue.com", group: "frameworks", bespoke: false, scrape: { query: "topic:vue", minStars: 50, exclude: ["vuejs/core", "vuejs/vue"] } },
  { slug: "angular", techName: "Angular", domain: "madewithangular.com", group: "frameworks", bespoke: false, scrape: { query: "topic:angular", minStars: 50, exclude: ["angular/angular"] } },
  { slug: "svelte", techName: "Svelte", domain: "madewithsvelte.com", group: "frameworks", bespoke: false, scrape: { query: "topic:svelte", minStars: 30, exclude: ["sveltejs/svelte"] } },
  { slug: "jquery", techName: "jQuery", domain: "madewithjquery.com", group: "frameworks", bespoke: false, scrape: { query: "topic:jquery", minStars: 20, exclude: ["jquery/jquery"] } },
  { slug: "alpine", techName: "Alpine.js", domain: "madewithalpine.com", group: "frameworks", bespoke: false, scrape: { query: "topic:alpinejs", minStars: 10, exclude: ["alpinejs/alpine"] } },
  { slug: "solidjs", techName: "SolidJS", domain: "madewithsolidjs.com", group: "frameworks", bespoke: false, scrape: { query: "topic:solidjs", minStars: 20, exclude: ["solidjs/solid"] } },
  ...
  { slug: "express", techName: "Express", domain: "madewithexpress.com", group: "frameworks", bespoke: false, scrape: { query: "topic:express", minStars: 50, exclude: ["expressjs/express"] } },
  { slug: "nestjs", techName: "NestJS", domain: "madewithnestjs.com", group: "frameworks", bespoke: false, scrape: { query: "topic:nestjs", minStars: 30, exclude: ["nestjs/nest"] } },
  { slug: "fastapi", techName: "FastAPI", domain: "madewithfastapi.com", group: "frameworks", bespoke: false, scrape: { query: "topic:fastapi", minStars: 30, exclude: ["tiangolo/fastapi"] } },
  { slug: "flask", techName: "Flask", domain: "madewithflask.com", group: "frameworks", bespoke: false, scrape: { query: "topic:flask", minStars: 30, exclude: ["pallets/flask"] } },
  { slug: "gin", techName: "Gin", domain: "madewithgin.com", group: "frameworks", bespoke: false, scrape: { query: "topic:gin", minStars: 20, exclude: ["gin-gonic/gin"] } },
  { slug: "fiber", techName: "Fiber", domain: "madewithfiber.com", group: "frameworks", bespoke: false, scrape: { query: "topic:fiber", minStars: 10, exclude: ["gofiber/fiber"] } },
...
async function scrapeDomain(gh, domain, now) {
  ...
  for (const [lo, hi] of STAR_PARTITIONS) {
    ...
    const { search } = await gh.graphql(SEARCH, { q, n: 50 });
  ...
  if ((seg[0] === "refresh" || seg[0] === "republish") && method === "POST") {
    ...
    if (seg[0] === "refresh") {
      ...
      for (const d of targets) {
        try {
          results2.push({ slug: d.slug, published: (await scrapeAndPublish(gh, env.DATA, db, d, Date.now())).projects.length });
        } catch (err) {
          console.error(`refresh failed for ${d.slug}: ${err.message}`);
          results2.push({ slug: d.slug, error: err.message });
        }
      }
      ctx.waitUntil(triggerDeploy(env));
      return json({ refreshed: results2 });
    }
    const results = [];
...
// .wrangler/tmp/bundle-NhKlNM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NhKlNM/middleware-loader.entry.ts
